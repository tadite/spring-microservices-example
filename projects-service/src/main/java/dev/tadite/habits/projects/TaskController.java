...
public class TaskController {
    ...
    public ResponseEntity<Page> getAllPagedByProject(Pageable pageable, @PathVariable Long projectId) {
    ...
    public ResponseEntity<TaskDto> create(@RequestBody TaskCreationRequest taskCreationRequest, @PathVariable Long projectId) {
